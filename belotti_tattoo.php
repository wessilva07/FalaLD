...
function inserirComentario($nome, $comentario, $avaliacao)
{
  ...
  $sql = "INSERT INTO belotti_tatoo (nome, comentario, avaliacao) VALUES ('$nome', '$comentario', $avaliacao)";
  $result = $conn->query($sql);

  if ($result) {
    // Atualizar a média das avaliações
    $sqlUpdate = "UPDATE belotti_tatoo SET total_avaliacoes = total_avaliacoes + 1, avaliacao = (avaliacao + $avaliacao) / (total_avaliacoes + 1) WHERE id = LAST_INSERT_ID()";
...
$sql = "SELECT nome, comentario, data_publicacao, avaliacao, total_avaliacoes FROM belotti_tatoo ORDER BY data_publicacao DESC";
$result = $conn->query($sql);
?>
...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="nav-principal">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link" type="button">Login</a>
            </li>
          </ul>
        </div>
      </div>
  ...
  <section class="mt-4">
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-sm-6 menu-outros-comercios" id="nav-principal">
          <h4>Outros comércios</h4>
          <ul>
            <li class="nav-item">
              <a href="#" class="nav-link" type="button">Tatuadores</a>
              <ul>
                <li><a href="#">Zagnoli Tattoo</a></li>
                <li><a href="belotti_tattoo.php">Belotti Tattoo</a></li>
              </ul>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link" type="button">Auto-Escola</a>
              <ul>
                <li><a href="#">Ouro Branco</a></li>
        ...
        <div class="col-md-6">
          <h1><strong>Belotti Tatoo</strong></h1>
          <img class="col-sm-6" src="imagens/belotti_tatoo_fotos/logo.cima.png" alt="" />
          <p class="mt-3">
            Muito prazer meu nome Jonas Belotti comecei a tatuar no ano de 2020 após vários pedidos de amigos e desde então não parei mais. Com o apoio dos meus amigos que foram minhas cobaias no início me aperfeiçoei e hoje me tornei um dos maiores tatuadores da região ja tendo feito mais de 100 tatuagens e tendo um portfolio variado entre tatuagens realistas, tribais, sombreadas, black work e Pontilhismo.
            <br>

          <h2 class="ml-4">Contato</h2>
                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img class="d-block w-10" src="imagens/belotti_tatoo_fotos/estudio1.png" alt="Primeiro Slide" />
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="imagens/belotti_tatoo_fotos/tatuagem2.png" alt="Segundo Slide" />
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-10" src="imagens/belotti_tatoo_fotos/tatuagem4.png" alt="Terceiro Slide" />
                    </div>
                  </div>
  ...
  <footer class="bg-primary text-light py-4">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h5>Contato</h5>
          <p>Endereço: Rua Exemplo, Número 123</p>
          <p>Email: contato@example.com
            Telefone: (XX) XXXX-XXXX</p>
        </div>
        <div class="col-md-6">
          <h5>Navegação</h5>
          <ul class="list-unstyled">
            ...
            <!-- Adicione outros itens de menu relevantes aqui -->
          </ul>
        </div>
      </div>
    </div>
  ...
  <script src="scripts/estrelas.js"></script>
