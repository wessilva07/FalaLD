...
function inserirComentario($nome, $comentario, $avaliacao)
{
  ...
  $sql = "INSERT INTO deck_bar (nome, comentario, avaliacao) VALUES ('$nome', '$comentario', $avaliacao)";
  $result = $conn->query($sql);

  if ($result) {
    // Atualizar a média das avaliações
    $sqlUpdate = "UPDATE deck_bar SET total_avaliacoes = total_avaliacoes + 1, avaliacao = (avaliacao + $avaliacao) / (total_avaliacoes + 1) WHERE id = LAST_INSERT_ID()";
...
$sql = "SELECT nome, comentario, data_publicacao, avaliacao, total_avaliacoes FROM deck_bar ORDER BY data_publicacao DESC";
$result = $conn->query($sql);
?>
...
<body>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <img class="col-sm-6" src="imagens/deck_fotos/logo_deck.png" alt="" />
          <p class="mt-3">
            O Deck café bar nasceu de um sonho de Mateus e Laise que queriam
            montar um bar em lima duarte e encontraram um otimo lugar no
            centro da cidade. Odeck fica localizado no calçadão de Lima
            Duarte, mas precisamente ma rua Antonio Carlos numero 121, loja 1.
            É servido diariamente um almoço delicioso, porções variadas,
            lanches e até mesmo hamburguer durante o dia.
          </p>
          <p>
            A noite o deck vira um bar com diversas atrações musicais nos fins
            de semana atraindo diversas pessoas, quando o assunto é pagode o
            Deck fica lotado pois a população de Lima Duarte é apaixonada por
            pagode e samba.
          </p>
          <br>
                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img class="d-block w-10" src="imagens/deck_fotos/cerveja_deck.jpg" alt="Primeiro Slide" />
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="imagens/deck_fotos/deck_atendi.jpg" alt="Segundo Slide" />
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-10" src="imagens/deck_fotos/hamb_deck.jpg" alt="Terceiro Slide" />
                    </div>
                  </div>
  ...
  <script src="scripts/menu_responsivo.js"></script>
