  ...
  <section class="mt-4">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <h1><strong>Barbearia Rodrigues</strong></h1>
          <img class="col-sm-6" src="imagens/barbearia_fotos/logo_barbearia.jpeg" alt="" />
          <p class="mt-3">
                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img class="d-block w-100" src="imagens/barbearia_fotos/apresentacao.jpg" alt="Primeiro Slide" />
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="imagens/barbearia_fotos/equipamento.jpeg" alt="Segundo Slide" />
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="imagens/barbearia_fotos/corte.jpg" alt="Terceiro Slide" />
                    </div>
                  </div>
